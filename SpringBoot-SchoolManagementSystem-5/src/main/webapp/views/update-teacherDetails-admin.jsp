...
<input class="btn btn-outline-success my-2 my-sm-0 text-light" name="submit" onclick="return validate()" id="submit" tabindex="13" value="Update" type="submit"> 
		...
		<div class="card bg-success"
					...
					<div class="card-header text-center text-light font-weight-bolder">Update Teacher Details</div>
					<div class="card-body bg-light" style="border-radius: 10px;">
						<form:form id="registrationform" action="../admin/updateTeacherDetails" 
						method="post" modelAttribute="employee">
							<div class="row">
							...
							<div class="row ">
								...
								value="${employee.firstName }"			aria-label="firstName" aria-describedby="basic-addon2"
											required="required">
							...
							value="${employee.lastName }"				aria-label="lastName" aria-describedby="basic-addon2"
											required="required">
...
<div class="row">
							...
							<div class="row ">
								...
								<div class="col-sm-3 text-left">
									...
									<div class="input-group mb-6 ">
										<input type="date" class="form-control" tabindex="5" id="dateOfBirth" value="${employee.dateOfBirth }"
       min="1994-01-01" max="2016-12-31" name="dateOfBirth" tabindex="4">
								...
								<div class="col-sm-3 text-left">
									...
									<div class="input-group mb-6 ">
										<input class="form-control" type="password"
											id="confirmPassword" name="confirmPassword" tabindex="6"
...
<div class="row"><div class="col-sm-12 text-right"><div style="color: red;font-size: 12px;margin-right: 15%  "><label id="warningLabel" name="warningLabel">${error}</label></div></div></div>
...
<div class="row ">
								...
								<div class="col-sm-3 text-left">
									...
									<div class="input-group mb-6 ">
										<input id="phone" name="phoneNumber"
											placeholder="phone number" required tabindex="7" type="tel"
								...
								<div class="col-sm-3 text-left">
									...
									<div class="input-group mb-6 ">
										<input id="phone" name="alternateNumber"
											placeholder="alternate number" required tabindex="8" type="tel"
											pattern="[0-9]{10}" class="form-control"
							...
							<div class="row ">
								...
								<div class="col-sm-3 text-left">
									...
									<div class="input-group mb-6 ">
										<input type="number" class="form-control" id="houseNumber"
											name="houseNumber" pattern="[0-9]" tabindex="9"
											placeholder="Enter houseNumber " aria-label="houseNumber"
										value="${employee.address.houseNumber }"	aria-describedby="basic-addon2" required="required">
								...
								<div class="col-sm-3 text-left">
									...
									<div class="input-group mb-6 ">
										<input type="number" class="form-control" id="pincode" tabindex="10" name="pincode" placeholder="Enter Pin Code" aria-label="houseNumber"
									value="${employee.address.pincode }"		aria-describedby="basic-addon2" required="required">
...
<div class="row ">
								...
								<div class="col-sm-3 text-left">
									...
									<div class="input-group mb-6 ">
										<input type="text" class="form-control" id="streetName" tabindex="11" name="streetName" placeholder="Street Address"
								...
								<div class="col-sm-3 text-left">
									...
									<div class="input-group mb-6 ">
										<select class="form-control" name="city" tabindex="12">
...
<div class="row"><div class="col-sm-12 text-center"><div style="color: red;font-size: 15px; "><label >${errormsg} ${usermsg }</label></div></div>
							...
							<div class="row">
								<div class="col-sm-12 text-center text-dark">
									<input onclick="return validate()" id="regButton" type="submit" tabindex="14" value="Update"
