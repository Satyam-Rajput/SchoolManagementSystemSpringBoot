...
<body class="sb-nav-fixed bg-white">
	...
	<div class="container">
		<div >
			<h3 class="text-center text-light">Student Registration Form</h3><br/>
			
				<div class="panel-body">
					<form:form id="addStudentForm" action="../admin/saveStudent" cssClass="form-horizontal"
						method="post" modelAttribute="student">
						
						<div class="row">
						<div class="col-sm-12" align="left"><input type="hidden" " name="id" id="id"  hidden=""/></div>
...
<input id="fatherName" name="fatherName" placeholder="Enter Father Name " required tabindex="5" type="text">
						...
						<form:form id="addStudentForm" action="../admin/saveStudent"
							...
							<div class="row ">
								...
								<div class="col-sm-3 text-left">
									...
									<div class="input-group mb-6 ">
										<input type="text" class="form-control" id="fatherName" tabindex="3"
								...
								<div class="col-sm-3 text-left">
									...
									<div class="input-group mb-6 ">
										<input class="form-control" type="password" id="password"
											name="password" placeholder="Enter password " tabindex="6"
...
<div class="row">
       ...
       min="1994-01-01" max="2016-12-31" name="dateOfBirth" tabindex="7">
...
<div class="row ">
							...
							<div class="row ">
								...
								<div class="col-sm-3 text-left">
									...
									<div class="input-group mb-6 ">
										<input type="number" class="form-control" id="houseNumber"
											name="houseNumber" pattern="[0-9]" tabindex="11"
								...
								<div class="col-sm-3 text-left">
									...
									<div class="input-group mb-6 ">
										<input type="number" class="form-control" id="pincode" tabindex="12" name="pincode" placeholder="Enter Pin Code" aria-label="houseNumber"
											aria-describedby="basic-addon2" required="required">
              ...
              <option value="Israel">Israel</option>
							...
							<div class="row">
								<div class="col-sm-12 text-center text-dark">
									<input onclick="return validate()" id="regButton" type="submit"  tabindex="17"value="Register"
			...
			<footer class="py-4 bg-dark mt-auto">
				<div class="container-fluid">
					<div
						...
						<div class="text-muted">Copyright &copy; Alpha School
							Management System 2020</div>
