...
<html lang="en">
    <head>
      ...
      <body class="bg-light" style="background-repeat: no-repeat;" background="<c:url value="/resources/static/images/teacher.jpg"/>"/>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
            ...
            <img src="<c:url value="/resources/static/images/logo1.jpg"/>" alt="Logo" style="width:60px; "></a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button
            ><!-- Navbar Search-->
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                 ...
                 <div class="card " style="width:80%;margin-left:10%;margin-top:3%;">
  ...
  <div class="card-body">
		...
		<c:url var="updateLink" value="../employee/updateDetails">
...
<div class="col-md-3 text-dark">${teacher.firstName}&nbsp;${teacher.lastName}</div>
<div class="col-md-3"></div></div><br/>

<div class="row text-left">
<div class="col-md-3"></div>
<div class="col-md-3 text-dark font-weight-bold">Email ID :</div>
<div class="col-md-3 text-dark">${teacher.email}</div>
<div class="col-md-3"></div></div><br/>
<div class="row text-left">
<div class="col-md-3"></div>
<div class="col-md-3 text-dark font-weight-bold">Contact No :</div>
<div class="col-md-3 text-dark">${teacher.phoneNumber}</div>
<div class="col-md-3"></div></div><br/>
<div class="row text-left">
<div class="col-md-3"></div>
<div class="col-md-3 text-dark font-weight-bold">Address :</div>
<div class="col-md-4 text-dark">${teacher.address.houseNumber},&nbsp;${teacher.address.streetName},&nbsp;${teacher.address.city},&nbsp;${teacher.address.state},&nbsp;${teacher.address.country}-${teacher.address.pincode}</div>
<div class="col-md-2"></div></div><br/>
<div class="row text-left">
<div class="col-md-3"></div>
<div class="col-md-3 text-dark font-weight-bold">Date Of Birth :</div>
<div class="col-md-3 text-dark">${teacher.dateOfBirth}</div>
<div class="col-md-3"></div></div><br/>
<div class="row text-left">
<div class="col-md-3"></div>
<div class="col-md-3 text-dark font-weight-bold">Date Of Joining :</div>
<div class="col-md-3 text-dark">${teacher.dateofJoining}</div>
<div class="col-md-3"></div></div><br/>


<div class="row ">

<div class="col-md-12 text-light text-center"><a  class="btn btn-primary badge-pill" style="width:100px" href="${updateLink}">Update</a></div>
