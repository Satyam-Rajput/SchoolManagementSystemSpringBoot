...
<html lang="en">
  ...
  <div class="card-header bg-success text-light text-center font-weight-bold">
    View Student's Personal Details
  </div>
  <br/>
  <div class="card-body">
...
&nbsp;
					...
					<div	class="col-md-3 "><div style="color: red;font-size: 15px;margin-right: 15%  "><label id="warningLabel" name="warningLabel">${error}${usermsg}${errormsg}</label></div></div>
