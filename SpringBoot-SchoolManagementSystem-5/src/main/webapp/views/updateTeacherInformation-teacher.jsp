	...
	<div class="container">
		<div >
				...
				<div class="panel-body">
					<form:form id="registrationform" action="../employee/updateInformation" cssClass="form-horizontal"
						method="post" modelAttribute="employee">
						<div class="row">
				
						<div class="col-sm-6" align="left"><input type="number" value="${employee.id }" name="id" id="id"  hidden=""/></div></div>
...
<input class="btn btn-outline-success my-2 my-sm-0 text-light" name="submit" onclick="return validate()" id="submit" tabindex="13" value="Update Details" type="submit"> 
</div></div></form:form>
				</div>
			</div>
		</div>
...
<div class="row">
<div class="col-sm-12 text-center"><div style="color: red;font-size: 15px;font-style: italic; ">${errormsg} ${usermsg}</div></div></div>
