...
<div class="row ">
					<div class="col-sm-1 text-center"></div>
					<div class="col-sm-4 text-left">
						<p class="text-dark"><label for="Id">Attendence</label></p>
</div>

<div class="col-sm-6 text-left">

<div class="input-group mb-6 ">
  <input type="number" pattern="[0-9]" required="required" tabindex="2" class="form-control" id="attendence" name="attendence" placeholder="Enter attendence" aria-label="id" aria-describedby="basic-addon2">
...
<div class="row">
<div class="col-sm-12 text-center"><div style="color: red;font-size: 15px;font-style: italic; ">${error} ${usermsg}</div></div></div>
