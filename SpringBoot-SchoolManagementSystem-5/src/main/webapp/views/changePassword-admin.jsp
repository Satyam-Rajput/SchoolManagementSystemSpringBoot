   ...
   function validate()
   {
	   ...
	   if(newpass!=conpass)
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
            <a class="navbar-brand" href="../admin/adminPage"><img src="<c:url value="/resources/static/images/logo1.jpg"/>" alt="Logo" style="width:60px; ">
		...
		<div >
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<form:form action="../admin/changePassword" cssClass="form-horizontal"
						method="post" >
